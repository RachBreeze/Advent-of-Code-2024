...
public class ReactorTests
{
    ...
    public void ReportIsSafe_EmptyLevels_ThrowsArgumentException()
    {
        ...
        Assert.Throws<ArgumentException>(() => reactor.ReportIsSafe(report.Levels));
    }
    ...
    public void ReportIsSafe_SafeReport_ReturnsTrue()
    {
        ...
        var result = reactor.ReportIsSafe(report.Levels);
    ...
    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine1_ReturnsTrue()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 7, 6, 4, 2, 1 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
        Assert.IsTrue(result);
    }

    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine2_ReturnsFalse()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 1, 2, 7, 8, 9 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
    ...
    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine3_ReturnsFalse()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 9, 7, 6, 2, 1 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
    ...
    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine4_ReturnsTrue()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 1, 3, 2, 4, 5 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
    ...
    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine5_ReturnsFalse()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 8, 6, 4, 4, 1 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
    ...
    [Test]
    // sample data from https://adventofcode.com/2024/day/2
    public void ReportIsSafeUsingDampner_SampleDataLine6_ReturnsTrue()
    {
        var reactor = new Reactor();
        var report = new Report { Levels = new List<int> { 1, 3, 6, 7, 9 } };
        var result = reactor.ReportIsSafeUsingDampner(report.Levels);
